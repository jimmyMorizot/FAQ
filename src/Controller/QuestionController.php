...
class QuestionController extends AbstractController
{
    ...
    public function show(Question $question, Request $request, UserRepository $userRepository, AnswerRepository $answerRepository)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            // Is question inactive ?
            if ($question->getActive() === false) {
                throw $this->createAccessDeniedException('La question désactivée.');
            }

            // on met à jour la question à la date courante
    ...
    public function edit(Question $question, Request $request, UserRepository $userRepository)
    {
        ...
        $this->denyAccessUnlessGranted('edit', $question, 'Vous ne pouvez pas accéder à cette ressource.');
