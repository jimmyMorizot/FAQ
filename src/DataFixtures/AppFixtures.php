...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        for ($i = 1; $i < 30; $i++) {
            ...
            // @see https://fakerphp.github.io/formatters/date-and-time/#datetimeininterval
            // date de mise à jour entre maintenant et -14 jours
            $dateTime = $generator->unique()->dateTimeInInterval($startDate = 'now', $interval = '-14 days', $timezone = null);
            // Faker ne proposant pas de DateTimeImmutable, on en crée un à partir du DateTime
            $question->setUpdatedAt(new DateTimeImmutable($dateTime->format('Y-m-d H:i:s')));
            // question active par défaut
