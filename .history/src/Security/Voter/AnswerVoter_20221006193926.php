...
class AnswerVoter extends Voter
{
    ...
    protected function voteOnAttribute(string $attribute, $subject, TokenInterface $token): bool
    {
        ...
        // on vérifie si la reponse a une question
        if(null === $answer->getQuestion()) return false;
        ...
        switch ($attribute) {
            case 'ANSWER_VALIDATOR':
                ...
                return $this->canValidate($answer, $user, $question);
                break;
    ...
    private function canValidate(Answer $answer, User $user, Question $question){
        // Le propriétaire de la reponse peut la modifier
        if ($answer === $question->getAnswers()) {
